...
const Landing = () => {
    ...
    return (
        <div className={`${isOpen && "mobileMax:h-screen mobileMax:overflow-hidden"}`}>
            <Header isOpen={isOpen} toggle={toggle} />
            <div className={`${isOpen && "mobileMax:bg-gray"}`}>
                <div className={`${isOpen && "mobileMax:opacity-0"}`}>
                    <div className={`${isOpen && "mobileMax:mt-0"} relative mt-[15px]`}>
                        <Banner />
